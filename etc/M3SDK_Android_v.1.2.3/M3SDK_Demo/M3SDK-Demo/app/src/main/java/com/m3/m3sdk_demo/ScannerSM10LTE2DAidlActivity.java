...
import com.sim.motorola.sdl.IScannerTestService;

import net.m3mobile.app.scannerservicez2d.IScannerServiceZebra2D;


public class ScannerSM10LTE2DAidlActivity extends Activity implements OnClickListener, ServiceConnection {
	// lib
	...
	private IScannerTestService m2DService = null;
	...
	public void onClick(View vw) {
		...
		try {
			if(id == R.id.startread){
				...
				m2DService.turnOnorOffScan(true);
			}else if(id == R.id.disable){
				m2DService.turnOnorOffScan(false);
			}
	...
	public void bindScannerService(){
		Intent intent = null;
		intent = new Intent("com.sim.motorola.sdl.ScannerTestService.start");
		intent.setPackage("com.m3.scanemul");
	...
	public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
		...
		m2DService = IScannerTestService.Stub.asInterface(iBinder);
		...
		try {
			...
			m2DService.turnOnorOffVibration(true);
